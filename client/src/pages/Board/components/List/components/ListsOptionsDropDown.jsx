...
const ListOptionsDropDown = ({ _id }) => {
   ...
   return (
		<div className="List__dropdown">
			<div onClick={onShow} className={clsx('List__dropdown-btn', isVisible && 'List__dropdown-btn--active')}>
            ...
            onClose={onClose}
				position="top"
            // className="List__dropdown-content"
			>
				<div className="List__dropdown-item" onClick={onDeleteList}>Удалить лист</div>
			</DropDown>
		</div>
	)
}
