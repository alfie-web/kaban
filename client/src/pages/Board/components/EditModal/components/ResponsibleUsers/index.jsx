            ...
            <div className="EditModal__selectedUsers">
               ...
               >
                  <path
                     fillRule="evenodd"
                     clipRule="evenodd"
                     d="M9.5 0C10.0523 0 10.5 0.447715 10.5 1V8.5H18C18.5523 8.5 19 8.94771 19 9.5C19 10.0523 18.5523 10.5 18 10.5H10.5V18C10.5 18.5523 10.0523 19 9.5 19C8.94771 19 8.5 18.5523 8.5 18V10.5H1C0.447715 10.5 0 10.0523 0 9.5C0 8.94771 0.447715 8.5 1 8.5H8.5V1C8.5 0.447715 8.94771 0 9.5 0Z"
                     fill="#8DA4B9"
                  />
               </svg>
            </div>
